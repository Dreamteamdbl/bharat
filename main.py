...
SUDO_USERS = [6133985472,1265309848]
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/dreamteamapp") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/dreamteamapp") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/dreamteamapp")                              
                ],           
            ]
      )
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[༄ᶦᶰᵈआशु࿐❥◉🇮🇳™](https://t.me/IFSASHU1)"
    if raw_text3 == '1':
        CR = '[༄ᶦᶰᵈआशु࿐❥◉🇮🇳™](https://t.me/IFSASHU1)'
    elif raw_text3:
        try:
    ...
    await editable.edit("𝗡𝗼𝘄 𝗦𝗲𝗻𝗱 𝗧𝗵𝗲 𝗧𝗵𝘂𝗺𝗯 𝗨𝗿𝗹 𝗘𝗴 » https://telegra.ph/file/0ce5dbbf938910d17daed-0a3bd9607bb0f12fbe.jpg\n\n𝗢𝗿 𝗜𝗳 𝗗𝗼𝗻'𝘁 𝗪𝗮𝗻𝘁 𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹 𝗦𝗲𝗻𝗱 = 𝗻𝗼")
